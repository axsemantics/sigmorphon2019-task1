...
@TrainerBase.register("ax_trainer")
class Trainer(TrainerBase):
    ...
    def _train_epoch(self, epoch: int) -> Dict[str, float]:
        ...
        if not self._metric_tracker.reinforce_start_with_low and (
                epoch < self._epoch_low_start or
                self._metric_tracker._epochs_with_no_improvement < self._epoch_without_improvement_low_start
        ):
        ...
        num_training_batches = math.ceil(self.iterator.get_num_batches(train_data)/num_gpus)
    ...
    def train(self) -> Dict[str, Any]:
        ...
        for epoch in range(epoch_counter, self._num_epochs):
            ...
            metrics["reinforce_start_with_low"] = self._metric_tracker.reinforce_start_with_low
    ...
    def from_params(cls,  # type: ignore
        ...
        epoch_without_improvement_low_start = params.pop_int("epoch_without_improvement_low_start", None)
        ...
        return cls(model, optimizer, iterator,
                   ...
                   epoch_without_improvement_low_start=epoch_without_improvement_low_start,
        )
